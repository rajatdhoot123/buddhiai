...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-[#1F222C] pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        ...
        <div className=" flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-white text-opacity-90 flex items-center text-sm font-medium">
                ...
                <span>{`+91${WHATSAPP_SUPPORT_NUMBER}`}</span>
              </p>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-white text-opacity-90 mb-9 text-lg font-semibold">
                Company
              </h4>
              <ul>
                {NAV_LIST.map(({ label, link }) => (
                  <li key={label}>
                    <Link
                      href={link}
                      className="text-white text-opacity-80 hover:text-primary mb-2 inline-block text-base leading-loose"
                    >
                      {label}
                    </Link>
                  </li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                {/* <a
                  href="javascript:void(0)"
                  className="text-white text-opacity-90 hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="8"
                    height="16"
                ...
                <a
                  target="_blank"
                  href="https://twitter.com/kwiktwik_co"
                  className="text-white text-opacity-90 hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="16"
                ...
                {/* <a
                  target="_blank"
                  href="https://www.linkedin.com/company/kwiktwik-co"
                  className="text-white text-opacity-90 hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="16"
